        ...
        <div className="bg-gradient-to-b from-white to-orange-50 ">
          <div className="container mx-auto px-4 py-16 lg:px-8 lg:py-32 xl:max-w-7xl">
            <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
              <div className="rounded-lg border-4 border-gray-300 bg-white p-5 shadow-sm transition duration-300 ease hover:border-orange-500 md:p-7 xl:p-10">
                <svg
              ...
              <div className="rounded-lg border-4 border-gray-300 bg-white p-5 shadow-sm transition duration-300 ease hover:border-orange-500 sm:col-span-2 md:p-7 lg:col-span-1 xl:p-10">
                <svg
